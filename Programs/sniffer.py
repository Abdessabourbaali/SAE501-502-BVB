...
# Fonction pour décoder une option DHCP avec gestion des erreurs
...
def handle_dhcp_packet(packet):
    if packet.haslayer(DHCP):
        dhcp_type = None
        packet_idx = packet[IP].id  # Packet ID as an example
        ...
        if dhcp_type is not None:
            ...
            # Extract additional DHCP options if present
            ...
            # Set expiration time based on lease time (if available)
